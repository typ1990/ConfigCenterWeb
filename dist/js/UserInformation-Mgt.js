...
function findProvince(){
    ...
    findData(jsonPrama,callback_findProvince);
...
//alert("33");
    ...
    findData(jsonPrama,callback_findCity);
...
function findShopAssistantByCriteria(p){
        ...
        findData(jsonPrama,callBack_findShopAssistantByCriteria);
...
function userInformation_findShopAssistantToExcel(p){
    ...
    findData(jsonPrama,callBack_findShopAssistantToExcel);
...
function checkByID(id){
    ...
    ////alert('json=='+JSON.stringify(json));
    //
    //findData(jsonPrama,callBack_getShopAssistantById);
}
...
function editByID(id){
    ...
    location.href="./UserInformation-Edit.html?id="+id+"";
    ...
    ////alert('json=='+JSON.stringify(json));
    //
    //findData(jsonPrama,callBack_getShopAssistantByIdEdit);
...
//alert("33");
    ...
    findData(jsonPrama,callback_findProvinceEdit);
...
//alert("33");
    ...
    findData(jsonPrama,callback_findCityEdit);
...
//alert("33");
    ...
    findData(jsonPrama,callback_findCountyEdit);
